...
//     std::cout<< "alpha:"<<v[0]<<"beta:"<<v[1]<<"gamma:"<<v[2]<<std::endl;
//     return {c1,c2,c3};
// }
                          ...
                          const Vector3f& dir, float& tnear, float& u, float& v)
{
    ...
    //std::cout<<"rayTriangleIntersect" <<coeff <<":"<<dir<<":"<<e2<<":"<<std::endl;
...
public:
    ...
    Vector3f evalDiffuseColor(const Vector2f& st) const override
    {
        ...
        return lerp(Vector3f(0.815, 0.235, 0.031), Vector3f(0.5, 0.5, 0.5), pattern);
    }
